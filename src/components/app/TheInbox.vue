<template>
  ...
  <div class="flex pt-[44px]">
    ...
    <div class="pt-[34px] ml-[305px] w-full">
      <div class="mx-[75.5px] px-[55px]">
        <div class="flex">
          <h1 class="text-[20px] font-bold">Inbox</h1>
          <div class="flex ml-auto">
            <button class="flex gap-1 hover:bg-[#f5f5f5] rounded-md px-3 py-1">
              <span>
            ...
            <button class="hover:bg-[#f5f5f5] rounded-md px-1">
        ...
        <div class="mt-5">
          <ul>
            <li
              id="goal_1"
              class="relative cursor-pointer flex gap-2 before:content-[''] before:absolute before:-left-7 before:w-[100px] before:h-full pb-4"
            >
              <button class="hover:bg-[#f5f5f5] rounded-md hidden absolute -left-7 drag_button">
